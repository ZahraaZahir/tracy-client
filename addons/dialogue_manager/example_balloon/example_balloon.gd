...
const TALK_SFX = preload("res://audio/sounds/button_click.wav")
...
var talk_sound: AudioStreamPlayer
...
func _ready() -> void:
	talk_sound = AudioStreamPlayer.new()
	talk_sound.stream = TALK_SFX
	talk_sound.bus = "sfx"
	add_child(talk_sound)
